...
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/FrontCompactAuboBox.jpg}}
\end{center}
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/systemSettings.png}}
\end{center}
\item In system settings open $‘Text Entry’$
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/TextEntry.png}}
\end{center}
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/addingDanishLayout.png}}
\end{center}
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/danishAddedToInputSources.png}}
\end{center}
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/LanguageChange.png}}
\end{center} 
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/networkWired.png}}
\end{center}
\item Select wired. The icon with the ethernet port not the arrows.
\item click options
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/wireOptionsEthernet.png}}
\end{center}
\item Select the IPv4 settings tab
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/IPv4SettingsAutomatic.png}}
\end{center}
\item In the Method dropdown bar select $'manual'$ 
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/ipv4SettingsManual.png}}
\end{center}
\item Click add and type in your desired IP, mask and gateway. 
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/IPv4SettingsWithAdress.png}}
\end{center}
\item Click save. 
\end{itemize}
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/settings.png}}
\end{center}
\item select $'system'$ in the bottom left. 
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/settingsSystem.png}}
\end{center}
\item Select update on the left. 
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/update.png}}
\end{center}
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/lisrofUpdateFiles.png}}
\end{center}
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{../../Images/FileImport.png}}
\end{center}
